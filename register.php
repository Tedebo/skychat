...
if($_POST['sub']){	
	...
	$res1 = mysqli_query($con, "SELECT * FROM account where user='$user'");
	
	$rows = mysqli_num_rows($res1);
	
	if($rows == 1){
		$error = "*Account Exists or Username in use";
	}else{
		mysqli_query($con, "INSERT INTO account(user, pass, rank) VALUES('$user', '$pass', '$rank')");
	...
	<div class="ui centered grid">
	    ...
	    <div class="eight wide column" id="result" style="margin-bottom: 8em;">
	    	<h2 class="ui center aligned icon header">
					  ...
					  Skychat Live
					  <h2 class="ui sub header red"><?php echo $error; ?></h2>
					</h2>
	 	...
	 	<form method="post">
			...
			<div class="ui blue submit button" style="padding: 0px; width: 100%;">
				<input style="border: 0px; background-color: rgba(0,0,0,0); padding: 1em 4em;" type="submit" name="sub" value="Register" required>
